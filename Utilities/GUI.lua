...
-- "MaterialLua" is not made by XenHub, credits go to their creators
-- This is just a mirror host with a small bit of adjustment
-- Full credits to the owners
-- Their github:
-- https://github.com/Kinlei/MaterialLua

-- Make sure to go check MaterialLua out!
...
function Material.Load(Config)
	...
	function TabLibrary.New(TabConfig)
		...
		function OptionLibrary.Dropdown(DropdownConfig)
			...
			function DropdownLibrary:SetSelected(Value)
				DropdownCallback(Value)
				DropdownTitle.Text = DropdownText..": "..Value
			end
